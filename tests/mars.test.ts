...
describe("utility", () => {
    ...
    test("advancing north", () => {
        expect(advance({position: [0, 0], direction: "N"})).toStrictEqual([0, 1])
    })
    test("advancing east", () => {
        expect(advance({position: [0, 0], direction: "E"})).toStrictEqual([1, 0])
    })
    test("advancing south", () => {
        expect(advance({position: [0, 0], direction: "S"})).toStrictEqual([0, -1])
    })
    test("advancing west", () => {
        expect(advance({position: [0, 0], direction: "W"})).toStrictEqual([-1, 0])
    })
    test("in bounds", () => {
...
describe("instruction processing", () => {
    test("going out of bounds", () => {
        ...
        expect(result).toStrictEqual({point: {position: [0, 3], direction: "N"}, lost: true})
    ...
    test("stops next going out of bounds", () => {
        ...
        expect(result).toStrictEqual({point: {position: [0, 3], direction: "N"}, lost: true})
        expect(second).toStrictEqual({point: {position: [0, 3], direction: "N"}, lost: false})
        expect(world.lostPositions).toContainEqual("0-3")
    })
    test("first example", () => {
        ...
        const result = processInstruction(world, instructions)
        expect(result).toStrictEqual({point: {position: [1, 1], direction: "E"}, lost: false})
    ...
    test("second example", () => {
        ...
        const result = processInstruction(world, instructions)
        expect(result).toStrictEqual({point: {position: [3, 3], direction: "N"}, lost: true})
    ...
    test("third example (after second)", () => {
        ...
        const result = processInstruction(world, instructions)
        expect(result).toStrictEqual({point: {position: [2, 3], direction: "S"}, lost: false})
    })
})