import {execute, parseInstructions, parseStart, parseWorld, parseFile} from "../src";
...
describe("parsing", () => {
    test("start", () => {
        ...
        expect(parseStart("50 50 S")).toStrictEqual({position: [50, 50], direction: "S"})
    })
